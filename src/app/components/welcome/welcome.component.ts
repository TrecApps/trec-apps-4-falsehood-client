...
import { AuthService, ElementContainerDirective, ElementItemDirective } from '@tc/tc-ngx-general';
...
@Component({
  ...
  imports: [TopBarComponent, ElementContainerDirective, ElementItemDirective],
